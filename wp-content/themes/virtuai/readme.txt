...
VirtuAI is an innovative,  easily customizable, multi-purpose theme, focused on empowering users to build astonishing WordPress websites. VirtuAI is mainly designed for small businesses, startups, or personal portfolio websites and works perfectly with Kubio Page Builder which enriches the WordPress block editor with a variety of new blocks and advanced styling options to give you full design freedom.

== Frequently Asked Questions ==

= How can I customize VirtuAI? =

    To customize the VirtuAI theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

VirtuAI WordPress theme, Copyright (C) 2021 ExtendThemes
VirtuAI WordPress theme is licensed under the GPL3.
