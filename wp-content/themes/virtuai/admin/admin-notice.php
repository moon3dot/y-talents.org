...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'       => virtuai_theme()->getPluginsManager()->getPluginState( virtuai_get_builder_plugin_slug() ),
			'install_url'  => virtuai_theme()->getPluginsManager()->getInstallLink( virtuai_get_builder_plugin_slug() ),
			'activate_url' => virtuai_theme()->getPluginsManager()->getActivationLink( virtuai_get_builder_plugin_slug() ),
			'slug'         => virtuai_get_builder_plugin_slug(),
			'messages'     => array(
...
<div class="virtuai-notice-dont-show-container">
    <button class="button-link virtuai-dont-show-notice">
        <?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
    </button>
</div>

<div class="virtuai-admin-notice-spacer">
	<div class="virtuai-admin-big-notice--container">
		<div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', virtuai_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', virtuai_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo virtuai_theme()->getListMarkerUrl()?>" alt="">
			...
			<div class="front-page-preview">
                <img src="<?php echo esc_url( virtuai_theme()->getFrontPagePreview() ); ?>"/>
			</div>
		</div>
	</div>
</div>
