...
$virtuai_theme_divider_style = array(
...
$virtuai_theme_action_button           = __( 'Let\'s start!', 'virtuai' );
$virtuai_theme_action_button_secondary = __( 'Contact us', 'virtuai' );

$virtuai_theme_click_pen_to_edit_title = __( 'Elevating Experiences, Empowering Connections', 'virtuai' );
$virtuai_lorem_ipsum                   = __('Discover a world of seamless possibilities with us. Unleash innovation, explore excellence, and redefine your digital journey. Welcome to a space where every click opens the door to new horizons.', 'virtuai');


return array(
	'default_icon'                 => $virtuai_theme_svg_icons['fort-awesome'],
	'icons'                        => $virtuai_theme_svg_icons,
	'divider_style'                => $virtuai_theme_divider_style,
	'lorem_ipsum'                  => $virtuai_lorem_ipsum,
	'edit_this_text_in_customizer' => $virtuai_theme_click_pen_to_edit_title,
	'gradients'                    => $virtuai_gradients,
	...
	'front-header' => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $virtuai_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $virtuai_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $virtuai_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'center',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $virtuai_gradients['front_header_default_overlay'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $virtuai_gradients['night_fade'],
									),
									'attachment' => 'fixed',
								),
							),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $virtuai_theme_svg_icons['facebook-square'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $virtuai_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $virtuai_theme_svg_icons['youtube-play'],
						'link_value' => '#',
						'index'      => 2,
					)
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $virtuai_theme_svg_icons['map-marker'],
						'text'       => 'Location, State, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $virtuai_theme_svg_icons['phone'],
						'text'       => '(000) 123 12345',
						'link_value' => 'tel:+400 098 765 432',
						'index'      => 1,
					),
					array(
						'icon'       => $virtuai_theme_svg_icons['envelope'],
	...
	'header'                            => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $virtuai_gradients['inner_header_default_overlay'],
									'gradient_opacity' => 40,
									'shape'            =>
										array(
											'value'  => 'none',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $virtuai_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
					...
					array(
						'icon'       => $virtuai_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $virtuai_theme_svg_icons['yahoo-square'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $virtuai_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $virtuai_theme_svg_icons['phone-square'],
